...
# Global Variables
data_matrix = []
IMAGE_DIRECTORY = "/home/furdeengregg/Desktop/Senior Design Team & Gregg Data Collection"
...
def generate_heatmap(data_matrix):
    ...
    heatmap_filename = os.path.join(desktop_path, f"heatmap_{timestamp}.png")
...
class IntroScreen(Screen):
    def __init__(self, **kwargs):
        ...
        logo = Image(source='/home/furdeengregg/Downloads/ScanProTech_logo.png', 
                     size_hint=(None, None), size=(500, 500)) 
        layout.add_widget(logo)        
        self.add_widget(layout)

    def on_enter(self):
        Clock.schedule_once(self.switch_to_main, 100)
...
class PreviousScansScreen(Screen):
    def __init__(self, **kwargs):
        ...
        images_layout = BoxLayout(orientation='vertical', size_hint_y=None)
        ...
        for img_file in os.listdir(IMAGE_DIRECTORY):
            if img_file.endswith(('.png', '.jpg', '.jpeg')):
                ...
                image = Image(source=img_path, size_hint_y=None, height=200)
